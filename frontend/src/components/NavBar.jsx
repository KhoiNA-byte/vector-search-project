                  ...
                  style={
                    isActive
                      ? isFruitPage
                        ...
                        : isVisualPage
                        ? {
                            background: "linear-gradient(135deg, var(--color-amber-800) 0%, var(--color-stone-400) 60%, var(--color-lime-300) 100%)",
                            color: "#fff",
                            boxShadow: "0 4px 16px -2px rgba(138,95,65,0.3), 0 0 0 2px rgba(199,217,155,0.15)",
                          }
                        : isDocumentPage
                        ? {
